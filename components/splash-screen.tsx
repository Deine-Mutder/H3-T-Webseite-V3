  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex max-w-6xl flex-col items-center px-4">
        ...
        <p className="mb-12 text-center text-lg text-muted-foreground">Virtual Trucking Company</p>

        <div className="mb-8 text-center">
          <h2 className="mb-2 text-xl text-foreground">{t.splash.title}</h2>
        ...
        <div className="grid w-full grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
          {languageOptions.map((lang) => (
            <button
              ...
              className={`relative min-h-[170px] overflow-hidden rounded-xl border-2 px-10 py-8 transition-all duration-300 ${
        ...
        <div className="relative mt-16 h-12 w-full max-w-md overflow-hidden">
